		<!-- Slider
		============================================= -->
		<section id="slider" class="slider-element slider-parallax full-screen clearfix" style="background: #FFF url('https://images.pexels.com/photos/39284/macbook-apple-imac-computer-39284.jpeg?auto=compress&cs=tinysrgb&dpr=2&h=750&w=1260') center center no-repeat; background-size: cover; max-height: 350px;">
                    ...
                    <!-- <h2 align="center">Our Teams</h2> -->
                        ...
                        <!-- <h2 style="float: right;">kjsdhvkjsdjksdj</h2> -->
							<div class="slider-title">
								...
								<h2 align="center" style="color: black;">{{ $judul }}</h2>
		...
		<section id="content">
			...
			<div class="content-wrap">
				...
				<div class="heading-block center">
						...
						<span>We have many templates which will fit you needs</span>
					</div>
	<div class="container clearfix">
