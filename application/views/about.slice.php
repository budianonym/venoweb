			...
			<div class="fslider" data-pagi="false" data-animation="fade">
				<div class="flexslider">
					<div class="slider-wrap">
						<div class="slide"><a href="#"><img src="{{ base_url('assets/images/about/4.jpg')}}" alt="About Image"></a></div>
						<div class="slide"><a href="#"><img src="{{ base_url('assets/images/about/5.jpg')}}" alt="About Image"></a></div>
						<div class="slide"><a href="#"><img src="{{ base_url('assets/images/about/6.jpg')}}" alt="About Image"></a></div>
						<div class="slide"><a href="#"><img src="{{ base_url('assets/images/about/7.jpg')}}" alt="About Image"></a></div>
					</div>
				</div>
			</div>
...
<!-- 		<div class="col_one_fourth center" data-animate="bounceIn">
		...
		<div class="container clearfix">
					...
					<div class="col_one_third">
						...
						<p>We provide : Well Experienced Team, Fast Response, Full Maintenance, Clean Codes, SEO Friendly, 100% Guarantee, No Hidden Cost, On Time, and Transparancy.</p>
					...
					<div class="col_one_third">
						...
						<p>Creating High Quality Website and Provide Statistic of Big Data.</p>
					...
					<div class="col_one_third col_last">
						...
						<p>Serving Frontend, Backend, and Full Stack Web Development.</p>
						<p>Also another web development like API Development, Web Testing, CMS Development, Fixing Bugs and Issues, Business Automation, Website Optimisation, and eCommerce Applications.</p>
